...
import com.mybatis.sinro.mybatisboot.common.utils.SafeUtils;
...
public class RequestWrapper extends HttpServletRequestWrapper {
	...
	public RequestWrapper(HttpServletRequest request, boolean filterXSS, boolean filterSQL) {
		super(request);
	...
	protected String filterParamString(String rawValue) {
		...
		if (this.filterXSS) {
			tmpStr = SafeUtils.stripXSS(rawValue);
		}
		if (this.filterSQL) {
			tmpStr = SafeUtils.stripSqlInjection(tmpStr);
		}
		return tmpStr;
	}
}
